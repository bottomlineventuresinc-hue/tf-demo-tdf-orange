/* Template Factory - TDF OC Electric live demo journey.
...
(function () {
  ...
  var LIVE_URL = 'https://bottomlineventuresinc-hue.github.io/tf-demo-tdf-orange/';
  var LS_CHANGES = 'tf_tdf_change_log_v1';
  var LS_PURCHASED = 'tf_tdf_purchased_v1';
      ...
      apply: function () {
        if (heroLede) {
          heroLede.textContent =
            'Residential electrical, panel work, and wiring across Orange and Orange County. You get a fixed itemised quote before we start, Traian as your named lead on site, and a twelve-month workmanship guarantee when we leave.';
        }
      }
    },
    {
  ...
  function setBarMode(mode) {
    ...
    if (!barSub) return;
    if (mode === 'updated') {
      barSub.textContent = 'Draft for Traian at TDF OC Electric. Claim it, preview the rest of the journey, or request a change.';
    } else {
      barSub.textContent = 'Draft for Traian Danut Faur at TDF OC Electric. Claim it, preview the rest of the journey, or request a change.';
    }
  }
  ...
  if (changeForm) {
    changeForm.addEventListener('submit', function (e) {
      ...
      runSpinner(
        ...
        'Updating the draft for TDF OC Electric. Hang tight.',
        delay,
        function () {
